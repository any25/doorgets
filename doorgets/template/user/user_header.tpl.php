...
<html lang="[{$doorGets->myLanguage()}]">
    ...
    [{?(count($doorGets->configWeb['addresses']) > 0 && !empty($doorGets->configWeb['gmaps'])):}]
    <script type="text/javascript" src="//maps.google.com/maps/api/js?key=[{!$doorGets->configWeb['gmaps']!}]&langue=[{!$doorGets->myLanguage!}]"></script>
