...
<div class="doorGets-rubrique-center">
    ...
    <div class="doorGets-rubrique-center-content">
        ...
        <div class="separateur-tb"></div>
        [{!$this->doorGets->Form->input('Google Maps API KEY','gmaps','text', $this->doorGets->configWeb['gmaps'])!}]
        <a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&reusekey=true&hl=Fr&pli=1">https://console.developers.google.com/flows/enableapi</a>
        <div class="separateur-tb"></div>
        <div class="separateur-tb"></div>
        [{!$this->doorGets->Form->input('Sharethis API KEY','sharethis','text', $this->doorGets->configWeb['sharethis'])!}]
        <a href="http://platform.sharethis.com/get-the-code">http://platform.sharethis.com/get-the-code</a>
        <div class="separateur-tb"></div>
