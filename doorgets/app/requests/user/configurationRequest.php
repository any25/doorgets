            ...
            case 'siteweb':
                ...
                if (!empty($this->doorGets->Form->i) ) {
                    ...
                    $excludedFields = array(
                        'statut','statut_ip','statut_tinymce','id_facebook','id_disqus','id_disqus','gmaps',
                    ...
                    if (empty($this->doorGets->Form->e)) {
                        ...
                        $dDefault['gmaps']       = $this->doorGets->Form->i['gmaps'];
                        $dDefault['sharethis']   = $this->doorGets->Form->i['sharethis'];
