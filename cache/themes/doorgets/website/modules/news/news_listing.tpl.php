        ...
        <?php if($Website->hasCategories): ?><div class="col-md-9"><?php else: ?><div class="col-md-12"><?php endif; ?>
            ...
            <div class="btn-group pull-right btn-add-content">
                <a href="<?php echo $urlAdd; ?>" class="btn btn-success btn-large">
                    ...
                    <span><?php echo $Website->__('Créer une actualité'); ?></span>
                </a>
            </div>
            <?php endif; ?>
            ...
            <div class="doorGets-listing-contents-title">
                <?php echo $ini; ?> <?php echo $Website->__('à'); ?> <?php echo $finalPer; ?> <?php echo $Website->__('sur'); ?> <b><?php echo $totalContents; ?> <?php if($totalContents > 1): ?> <?php echo $Website->__('actualités'); ?> <?php else: ?>  <?php echo $Website->__('actualité');  endif; ?></b>
                <?php if(!empty($q)): ?>
            ...
            <?php if(
                ...
                || $this->modulePrivilege['public_module']
                    ...
                    <?php foreach($contents as $content): ?>
                        <div class="row content-listing-news">    
                            <div class="col-md-2 left-date-news"><h3></h3><?php echo $content['date']; ?></div>
                            <div class="col-md-10 ">
                                <h3>
                ...
                <div class="info-not-found">
                    <?php echo $Website->__('Aucune actualité trouvée'); ?> <?php if(!empty($q)):  echo $Website->__('pour votre recherche');  endif; ?>.
                </div>
