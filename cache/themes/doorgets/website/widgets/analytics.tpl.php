...
<script type="text/javascript">
    ...
    //removeAllCookies();
    function showBanner() {
        var CNIL = '<div style="z-index:9999999;display: block;position: relative;width: 100%;top: 0;margin: auto 0;font-size: 12px;text-align: center;color: #7b7b7b;background-color: #fcf7e5;padding:10px;">' + "<?php echo $msgCookies; ?>" + ' <i class="fa fa-remove fa-lg pull-right"></i></div>'
    ...
    ga('create', '<?php echo $codeAnalytics; ?>', 'auto');
    ga('send', 'pageview');
</script>
<!-- doorGets:end:widgets/analytics --><?php endif; ?>
