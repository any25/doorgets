...
define('KEY_DOORGETS','JpptKou0itTpvdNOF89a');
...
define('URL',PROTOCOL.'localhost/doorgets/');
define('URL_ADMIN',PROTOCOL.'localhost/doorgets/');
define('URL_USER',PROTOCOL.'localhost/doorgets/dg-user/');
define('SQL_HOST','localhost');
define('SQL_LOGIN','esmn');
define('SQL_PWD','esmn123');
define('SQL_DB','doorgets');
define('SQL_VERSION','5.7.23');
